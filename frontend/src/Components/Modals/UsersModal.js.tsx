      ...
      >
        ...
        >
         ...
         { /*<TextField className={"modalTextField"} label={"Role"} type="text" value={model["role"]} onChange={(e) =>setModel((prev) => ({ ...prev, ["role"]: e.target.value }))}/>*/}
            ...
            className={"modalTextField"} disablePortal={true} options={["Admin", "User", "Staff", "Manager", "Partner","Select a role"]} onChange={(e, value) =>setTempModel((prev: any) => ({
              ...prev,
              "role": value
