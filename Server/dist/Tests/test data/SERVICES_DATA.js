...
const SERVICES_DATA = [
    ...
    },
    {
        ...
        name: "wwattam3",
        description: "Other injury of other muscles, fascia and tendons at shoulder and upper arm level, right arm, initial encounter",
        price: 770,
        position: {
            type: "Point",
            coordinates: [
    ...
    },
    {
        ...
        partnerId: new ObjectId("60b5c5b4c7a3c0b4e4f0f8c4"),
        name: "ieastcott4",
        description: "Traumatic rupture of unspecified ligament of right middle finger at metacarpophalangeal and interphalangeal joint, sequela",
        price: 531,
        position: {
            type: "Point",
            coordinates: [
