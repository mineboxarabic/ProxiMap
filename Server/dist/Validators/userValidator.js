...
export const userValidatorEdit = checkSchema({
    username: Object.assign(Object.assign({}, usernameValidator), { optional: { options: { nullable: true } } }),
    email: Object.assign(Object.assign({}, emailValidator), { optional: { options: { nullable: true } } }),
    role: {
        isIn: {
            options: [['Admin', 'User', 'Partner', 'Manager', 'Staff']],
            errorMessage: "Invalid role"
