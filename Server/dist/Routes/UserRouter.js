...
userRouter.get('/users', authenticateUser, (req, res, next) => autherizeUserRole(req, res, next, userRoutes.read.allowedRoles), readUsers);
userRouter.get('/users/me', readUsers);
//Get a single user
userRouter.get('/users/:id', checkId, isUserExist, (req, res, next) => ValidateRes(req, res, next), (req, res, next) => autherizeUserRole(req, res, next, userRoutes.read.allowedRoles), getUser);
//Create a user
userRouter.post('/users', userValidator, 
...
checkSchema({ password: passwordValidator }), (req, res, next) => ValidateRes(req, res, next), (req, res, next) => autherizeUserRole(req, res, next, userRoutes.create.allowedRoles), createUser);
//Update a user
userRouter.put('/users/:id', checkId, isUserExist, userValidatorEdit, (req, res, next) => ValidateRes(req, res, next), (req, res, next) => autherizeUserRole(req, res, next, userRoutes.update.allowedRoles), updateUser);
//Delete a user
userRouter.delete('/users/:id', checkId, isUserExist, (req, res, next) => ValidateRes(req, res, next), (req, res, next) => autherizeUserRole(req, res, next, userRoutes.delete.allowedRoles), deleteUser);
userRouter.post('/users/upload/:id', upload.single('file'), updateAvatar);
