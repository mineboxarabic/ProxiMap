...
askedServiceRouter.post('/askedServices', askedServiceValidator, ValidateRes, (req, res, next) => autherizeUserRole(req, res, next, askedServiceRoutes.create.allowedRoles), createAskedService);
//Get a single askedService
askedServiceRouter.get('/askedServices/:id', checkId, isAskedServiceExist, ValidateRes, (req, res, next) => autherizeUserRole(req, res, next, askedServiceRoutes.read.allowedRoles), readAskedService);
//Get the list of askedServices (All askedServices)
askedServiceRouter.get('/askedServices', (req, res, next) => autherizeUserRole(req, res, next, askedServiceRoutes.read.allowedRoles), readAskedServices);
askedServiceRouter.get('/askedServices/partner/:id', checkId, ValidateRes, (req, res, next) => autherizeUserRole(req, res, next, askedServiceRoutes.read.allowedRoles), readAskedServicesinMapViewOfUser);
askedServiceRouter.get('/askedServices/in-map-view/:swLat/:swLng/:neLat/:neLng', readAskedServicesinMapView);
//Update a askedService
askedServiceRouter.put('/askedServices/:id', checkId, isAskedServiceExist, askedServiceValidatorEdit, ValidateRes, (req, res, next) => autherizeUserRole(req, res, next, askedServiceRoutes.update.allowedRoles), updateAskedService);
//Delete a askedService
askedServiceRouter.delete('/askedServices/:id', checkId, (req, res, next) => autherizeUserRole(req, res, next, askedServiceRoutes.delete.allowedRoles), deleteAskedService);
